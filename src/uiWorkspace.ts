...
export function renderWorkspaceHtml(surface: MeasuredUiSurface, heldBy: string | null = null): string {
  ...
  </style></head><body><main><header class="masthead"><div><p class="eyebrow">Instrument workspace</p><h1>Measured by Nova</h1></div><p>No technical output loaded</p></header>
