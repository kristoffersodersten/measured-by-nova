...
export function renderWorkspaceHtml(surface: MeasuredUiSurface, heldBy: string | null = null, deliveryArtifacts: Array<{ format: string; sizeBytes: number; url: string }> = [], customerViews: { previewUrl?: string; viewerUrl?: string } = {}): string {
