...
CAD_WHITE = material("cad_sim_white_surface", (0.96, 0.96, 0.94, 1))
CAD_GREY = material("cad_sim_grey_context", (0.72, 0.72, 0.70, 1))
CAD_DARK = material("cad_sim_dark_roof_stone", (0.18, 0.18, 0.17, 1))
...
def main():
    ...
    print(f"CAD_SIMULATED_RENDERS={out_dir}")
