...
PROJECT_NAME = "Carport - CAD-simulated fasadritningar"
...
def draw_title_block(draw, page_w, page_h, title, page_no):
    ...
    draw.text((margin + 24, y + 78), "Ortografisk linjevy från 3D-modell", fill=(0, 0, 0), font=font(22))
...
def main():
    out_dir = Path("outputs/cad-simulated-export/carport-v8-freestyle-white-line")
    ...
    pdf_path = out_dir / "carport-cad-simulated-freestyle-white-line-all-views.pdf"
