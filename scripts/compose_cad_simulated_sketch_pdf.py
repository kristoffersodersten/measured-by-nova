...
PROJECT_NAME = "Carport - fasadritningar / CAD-simulated skiss"
...
def draw_title_block(draw, page_w, page_h, title, page_no):
    ...
    draw.text((margin + 24, y + 78), "Skiss / ortografisk fasadvy", fill=(0, 0, 0), font=font(22))
...
def main():
    out_dir = Path("outputs/cad-simulated-export/carport-v8-sketch-all-views")
    ...
    pdf_path = out_dir / "carport-cad-simulated-sketch-all-views.pdf"
