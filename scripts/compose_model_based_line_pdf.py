...
PROJECT_NAME = "Carport - modellbaserade fasadritningar"
MODEL_CONFIDENCE = "Skissvy med vit bakgrund. Mått enligt ansökan/platsmätning. Material och kulör enligt foton: vit träpanel, mörkt tak, mörk stenmur."
...
def draw_title_block(draw, page_w, page_h, title, page_no):
    ...
    draw.text((margin + 24, y + 78), "Ortografisk linjeritning från godkänd 3D-modell", fill=(0, 0, 0), font=font(22))
    ...
    draw.text((page_w - 730, y + 118), "Material/kulör: vit träpanel, mörkt tak, mörk stenmur", fill=(0, 0, 0), font=font(18))
...
def main():
    out_dir = Path("outputs/cad-simulated-export/carport-v8-model-based-line-all-views")
    ...
    pdf_path = out_dir / "carport-cad-simulated-model-based-line-all-views.pdf"
